    ...
    <div class="bg-gray-700 p-5 rounded-lg">
        ...
        <div class="bg-gray-800">
            ...
            <div class="bg-gray-600">
                ...
                <button @click="displayAccountDelete = !displayAccountDelete" class="cursor-pointer">Supprimer un utilisateur</button>
            </div>
            ...
            <div v-if="displayAccountDelete">
                <form @submit.prevent="submitFormRegister">
                    ...
                    <option v-for="user in user" :key="user.id" :value="user.username">{{ user.username }}</option>
                </select>
        ...
        <div class="bg-gray-800">
            ...
            <div class="bg-gray-600">
                ...
                <button class="cursor-pointer" @click="displayFileDelete = !displayFileDelete"> Retirer un système de la base de données</button>
            </div>
